...
const SOURCE_DIR = '/Volumes/Extreme SSD/2026/A&P26/Export';
const TARGET_DIR = path.join(process.cwd(), 'public', 'img', 'assaggia-2026');
const OUTPUT_JSON = path.join(process.cwd(), 'src', 'lib', 'data', 'assaggia-2026-gallery.json');
...
async function processPhotos() {
  ...
  for (const file of imageFiles) {
    ...
    const webPath = `/img/assaggia-2026/${newFilename}`;
