...
async function seed() {
  ...
  const jsonPath = path.join(process.cwd(), 'src', 'lib', 'data', 'assaggia-2026-gallery.json');
  ...
  for (const photo of galleryPhotos) {
    ...
    try {
      await sql`
        ...
        VALUES (${id}, ${photo.src}, 'Foto Assaggia e Passeggia 2026', 'assaggia26', ${photo.width}, ${photo.height})
